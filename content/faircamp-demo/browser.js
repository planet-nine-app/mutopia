...
const ARTISTS = [];
const RELEASES = [{coverProcedural:'cover_120.png?t_vHeZNk4U8',title:'Test Album',tracks:[{number:'1.',title:'one',url:'test-album/1/'},{number:'2.',title:'three',url:'test-album/2/'},{number:'3.',title:'two',url:'test-album/3/'}],url:'test-album/'}];
